...
# Agent Kits — 5 Agentes de Etapa do SDLC

![CAMADA 06 Agentes](https://img.shields.io/badge/CAMADA-06%20Agentes-7FBA00?style=for-the-badge) ![TOTAL 5 etapas](https://img.shields.io/badge/TOTAL-5%20etapas-1A1A1A?style=for-the-badge) ![USE 1 por estágio](https://img.shields.io/badge/USE-1%20por%20estágio-737373?style=for-the-badge)

> 🗺 **Você está aqui:** [Kit PT-BR](../README.md) → **Agentes de Estágio**


> **Para quem é isto?** Para o time inteiro entender como os 5 agentes de estágio funcionam.
>
> **O que você terá ao final desta leitura:**
>
> 1. Diferença entre persona-kits (coluna) e agent-kits (linha)
> 2. Os 5 agentes: @archaeologist, @architect, @builder, @evolution, @operations
...
| 5 · Operações | Pós-estágio (continuidade) | [@operations](05-operations/README.md) | Consolidar runbook, readiness, incidentes, observabilidade e hardening operacional |
...
| Persona | @archaeologist | @architect | @builder | @evolution | @operations |
| --- | --- | --- | --- | --- | --- |
| Product Owner | Observador | Secundário | Observador | Secundário | Observador |
| Requirements Engineer | **Protagonista** | Secundário | Observador | Observador | Observador |
| Enterprise Architect | Secundário | Secundário | Observador | Observador | Observador |
| Software Architect | Observador | **Protagonista** | Secundário | Observador | Secundário |
| Technical Lead | Observador | Secundário | Secundário | **Protagonista** | Secundário |
| Developer | Observador | Observador | **Protagonista** | Secundário | Observador |
| DBA | Secundário | Observador | Secundário | Observador | Observador |
| QA Engineer | Observador | Observador | Secundário | Secundário | Secundário |
| DevOps Engineer | Observador | Observador | Secundário | Secundário | **Protagonista** |
| Tech Writer | Secundário | Observador | Observador | Secundário | **Protagonista** |
